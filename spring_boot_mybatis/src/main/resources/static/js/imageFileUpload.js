$(document).ready(function(){
	$('#imageFileFrm').on('submit',function(){
		...
		$.ajax({
			...
			enctype: "multipart/form-data", // (form 태그에서 쓰이는 인코딩 방식)
