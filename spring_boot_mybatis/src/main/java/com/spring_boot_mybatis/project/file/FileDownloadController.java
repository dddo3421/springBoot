...
public class FileDownloadController {
	...
	public String fileDownloadList(Model model) {
		...
		File path = new File("C:/Spring/upload");
		String[] fileList = path.list();//객체가 directory로 구성된경우 디렉터리의 모든 파일 정보(파일명) 반환
